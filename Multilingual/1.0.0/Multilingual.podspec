#
#  Be sure to run `pod spec lint Multilingual.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/JustinYangJing/Multilingual.git" , :commit => "1c67036329377d638221d0962643677edf501892"}
