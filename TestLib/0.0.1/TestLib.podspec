...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/JustinYangJing/TestLib.git"
  ...
  s.source       = { :git => "https://github.com/JustinYangJing/TestLib.git" , :commit => "da31c16e59ccacb200678691883aab023c0cee3b"}
